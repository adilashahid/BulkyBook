...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagment(string userId)
        {
            ...
            {
                ApplicationUser = _unitOfWork.ApplicationUser.Get(u => u.Id == userId, includePropertities: "Company"),
        ...
        {
            List<ApplicationUser> objUserList = _unitOfWork.ApplicationUser.GetAll(includePropertities: "Company").ToList();
